...
export const mondayID = `mondayID___v1()_with_localStarage`//v1()
export const tuesdayID = `tuesdayID___v1()_with_localStarage`//v1()
export const wednesdayID = `wednesdayID___v1()_with_localStarage`//v1()
export const thursdayID = `thursdayID___v1()_with_localStarage`//v1()
export const fridayID = `fridayID___v1()_with_localStarage`//v1()
export const saturdayID = `saturdayID___v1()_with_localStarage`// v1()
export const sundayID = `sundayID___v1()_with_localStarage`//v1()
